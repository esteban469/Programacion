...
Instrucciones:
El programa debe pedirle al usuario que ingrese su peso en kilogramos y su altura en metros.
Utiliza la fórmula del IMC​
 
Después de calcular el IMC, el programa debe mostrar el resultado y, además, clasificarlo según los siguientes rangos:
