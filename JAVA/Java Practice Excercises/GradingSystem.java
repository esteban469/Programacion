...
public class GradingSystem {
    public static void main(String[] args) {
        ...
        String namesArray[] = new String[numberStudents]; // asignando el tamaño del arreglo con el numero de
                                                          // estudiantes
 ...
 * Crea un programa en Java que permita gestionar las calificaciones de un grupo
 * de estudiantes. El programa debe realizar las siguientes funciones:
 * 
 * Capturar nombres y calificaciones:
 * El programa debe solicitar al usuario que ingrese el nombre de cada
 * estudiante y su calificación (un valor numérico entre 0 y 100).
 * Utiliza un arreglo para almacenar las calificaciones y otro arreglo para los
 * nombres.
 * 
 * Mostrar las calificaciones:
 * El programa debe mostrar los nombres de los estudiantes junto con sus
 * calificaciones.
 * 
 * Calcular el promedio de las calificaciones:
 * El programa debe calcular el promedio de las calificaciones de todos los
 * estudiantes y mostrarlo en pantalla.
 * 
 * Calificación más alta y más baja:
 * El programa debe mostrar el nombre del estudiante con la calificación más
 * alta y el estudiante con la calificación más baja.
 * 
 ...
 * Utiliza estructuras de control como if/else y loops para manejar la lógica
 * del programa.
 * Debes manejar un arreglo (array) para las calificaciones y otro para los
 * nombres.
 * Utiliza el método Math.max() y Math.min() para encontrar la calificación más
 * alta y más baja.
